...
INPUT_CSV  = r"C:\Users\Guozhi\OneDrive - Australian National University\Code\PyGplate\Carbonatite1107\Sulfide deposit0210.csv"
OUT_GPML   = r"C:\Users\Guozhi\OneDrive - Australian National University\Code\PyGplate\Carbonatite1107\AssignedPoints.gpml"
OUT_CSV    = r"C:\Users\Guozhi\OneDrive - Australian National University\Code\PyGplate\Carbonatite1107\Sulfide deposit_PaleoCoords0210.csv"
...
for p in ROT_FILES + [STATIC_POLY, INPUT_CSV]:
    if not os.path.isfile(p):
        raise FileNotFoundError("loss " + p)
...
with open(INPUT_CSV, "r", encoding="utf-8-sig", newline="") as f:
    ...
    if not (col_age and col_lat and col_lon):
        raise RuntimeError("CSV lost Age / Latitude / Longitude")
...
print("[DONE] PlateID  + Reconstruction finished")
print("  GPML :", OUT_GPML)
print("  CSV  :", OUT_CSV)
